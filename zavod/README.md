...
<p>
  <img width='400px' src='https://github.com/primera7790/ZAVOD_project/blob/master/zavod/data/images/word_table_1.png' alt='word_table_1'/>
...
#### P.S. Также на руках ряд фотографий, данные с которых помогут в обучении ML-моделей.
...
## 3. Классифицируем заявки по фамилиям заявителей, применяя метод **kNN**
Файл: [kNN_optimized.py](https://github.com/primera7790/ZAVOD_project/blob/master/zavod/kNN_optimized.py)
- Используем **kNN**, метод ближайших соседей:
...
## 5. Классифицируем заявки по производствам, применяя алгоритм **Decision Tree**
...
### 5.2. Предсказываем принадлежность к конкретному производству
...
## Дополонительные задачи-улучшайзеры на будущее (TODO list):
- создать базу данных, разбить таблицу на ряд отдельных, со своей структурой, связанных между собой;
